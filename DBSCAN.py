# -*- coding: utf-8 -*-
"""Agrix_Group 2_Final.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1WuG0OdvYKenBWOJhEr_RM37AqyJ1fTIQ
...
############## Modified implementation of DBSCAN, pls ignore ########################3
...
scikitArray = []
for i in range (0, len(latitudeArray)):
  coordinates = []
...
GmmscikitArr = scikitArray
db = DBSCAN(eps=0.0002, min_samples=20).fit(scikitArray)
#core_samples_mask = np.zeros_like(db.labels_, =bool)
#core_samples_mask[db.core_sample_indices_] = True
labels = db.labels_
...
plt.scatter([x[1] for x in noiseArray], [x[0] for x in noiseArray], c = 'k', s = 6)
plt.scatter([x[1] for x in nonnoiseArray], [x[0] for x in nonnoiseArray], c = 'r', s = 6)
plt.plot()
plt.show()
plt.savefig(fname = "plots.png")'''
